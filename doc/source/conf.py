# -*- coding: utf-8 -*-
#
# CopyXnat documentation build configuration file, created by
...
# This is for instance for copyxnat.engine to be shown under the letter 'e'
...
latex_documents = [
    (master_doc, 'CopyXnat.tex', u'CopyXnat Documentation',
     u'Tom Doel', 'manual'),
]
...
man_pages = [
    (master_doc, 'copyxnat', u'CopyXnat Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'CopyXnat', u'CopyXnat Documentation',
     author, 'CopyXnat', 'One line description of project.',
     'Miscellaneous'),
]
