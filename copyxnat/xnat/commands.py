...
class Command:
    ...
    @abc.abstractmethod
    def run(self, xnat_item, inputs, outputs, from_parent):
...
class CommandReturn:
    ...
    def __init__(self, to_children=None, recurse=True, tostring=None):
...
class ExportCommand(Command):
    ...
    def run(self, xnat_item, inputs, outputs, from_parent):  # pylint: disable=unused-argument
...
class CheckDatatypesCommand(Command):
    ...
    def run(self, xnat_item, inputs, outputs, from_parent):  # pylint: disable=unused-argument
        ...
        return CommandReturn(tostring=check_datatypes_tostring)
